/****************************************************************************
** Meta object code from reading C++ file 'TFrame.h'
**
...
#include "../../FlipGame/TFrame.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'TFrame.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TFrame_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TFrame_t qt_meta_stringdata_TFrame = {
    {
QT_MOC_LITERAL(0, 0, 6), // "TFrame"
QT_MOC_LITERAL(1, 7, 7), // "iniciar"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 5) // "parar"

    },
    "TFrame\0iniciar\0\0parar"
};
...
const QMetaObject TFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_TFrame.data,
      qt_meta_data_TFrame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TFrame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TFrame.stringdata))
